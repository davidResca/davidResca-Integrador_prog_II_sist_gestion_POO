...
public:
	// constructor
	Empleado();
	Empleado(std::string nombre,std::string apellido,long long dni,int diaNasc,int mesNasc,int anioNasc,std::string correoElectronico,int diaAlta,int mesAlta,int anioAlta,float horasTrabajadas,long long CUIT,const std::string& observaciones, std::string direccion, long long telefono);
